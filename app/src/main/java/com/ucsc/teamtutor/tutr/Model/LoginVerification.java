...
public class LoginVerification {
    ...
    private FrontEndNode front_node = null;

    
    public LoginVerification() {front_node = new FrontEndNode();}
    /**
    ...
    private int passInEmailInfo(String email, String password){
        if(password == null)
            return 2;
        int res = front_node.verifyUserInfo(email, password);
        if (res == 1) return 3;
